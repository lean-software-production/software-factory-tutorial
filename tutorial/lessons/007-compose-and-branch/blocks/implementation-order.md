...
tutor: |-
  ...
  model does not naturally produce both outcomes. Clue toward message="$PWD/.tmp/commit-message.txt"
  if the commit cannot find the message file. The point is that the orchestrator recognises output
