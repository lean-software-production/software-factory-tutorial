...
You have been building stations since lesson 001, without the word for it. Every one of them was an
agent, headless, handed its input by a script. What this lesson adds is not a new kind of thing; it
is the order they run in, and the edge around them.
