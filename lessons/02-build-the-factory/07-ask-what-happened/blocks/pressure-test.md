...
Three scripts now sit above the line: one that runs it, one that watches it, one that answers
questions
about it. That is most of what a person needs to operate something they are not doing by hand.

Start a run and watch it. Two iterations in, the doer picks the wrong file — it has decided the
parser
