...
Allowlisted public judge trace. Citation IDs are the id fields in this array. This list contains public workbook state (including public editor projections and browser-public timeline metadata), learner-visible terminal transcript, public reflection turns, projected structural workbook progression events, and allowlisted artifact snapshots. Raw workbook timeline rows, raw event IDs, raw sequence numbers/timestamps, attempt/evidence/session IDs, terminal lifecycle records, private summaries, private failures, terminal HTML, and unknown future event types are not included. Public scenario/lesson/block/citation IDs and artifact paths remain. Judge-channel entry timestamps are removed; public state may retain browser-public timeline metadata already exposed by the workbook:
