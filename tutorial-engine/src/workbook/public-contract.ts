...
export type PublicTimelineMessage = { type: "message"; id: string; sequence: number; at: string; lessonId: string; blockId: string; role: "assistant" | "user"; source: "authored" | "learner" | "main_tutor" | "block_tutor"; presentation: "course" | "chat" | "hint" | "review"; text: string; blockInView?: string; };
