...
export interface AuthoredWorkbookEvalModelIdentities {
  ...
  "Practice Coach": AuthoredWorkbookEvalModelIdentity;
...
function modelRole(value: Record<string, unknown>, canonical: keyof AuthoredWorkbookEvalModelIdentities, legacy: "mainTutor" | "practiceCoach" | "judge"): AuthoredWorkbookEvalModelIdentity {
...
export function copyAuthoredWorkbookEvalModelIdentities(value: unknown): AuthoredWorkbookEvalModelIdentities {
  ...
  return deepFreeze({
    ...
    "Practice Coach": modelRole(value, "Practice Coach", "practiceCoach"),
...
function copyStrictAuthoredWorkbookEvalModelIdentities(value: unknown): AuthoredWorkbookEvalModelIdentities {
  if (!isPlainRecord(value)) throw new Error("Invalid authored workbook model identities.");
  assertExactKeys(value, ["Main Tutor", "Practice Coach", "Judge"], "authored workbook model identities");
  ...
  return deepFreeze({
    ...
    "Practice Coach": role("Practice Coach"),
    Judge: role("Judge")
  });
}
