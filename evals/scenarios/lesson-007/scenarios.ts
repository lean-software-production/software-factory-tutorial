...
export const lesson007Scenarios: Scenario[] = [
  ...
  { id: "mistake-repair-without-findings", lesson: "007", mode: "mistake", description: "Hands-on learner invokes the repair station without appending the validator's findings.", expectedMistake: "The repair station is asked to answer findings it was never handed, so it has nothing to repair and falls back to guessing.", seed: lesson006Seed, patches: [promptsStep(), findinglessDefect, branchRepair(findinglessDefect)], finalState: lesson007FinalState },
